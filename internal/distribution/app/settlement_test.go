...
func settlementFixture(t *testing.T, now time.Time) (*settlementStoreStub, *settlementPaymentStub, *SettlementService) {
	...
	payment := &settlementPaymentStub{state: paymentport.DistributionPaymentState{OriginalPaymentRef: "payref_17", ConfirmedPaid: true, SplitCapable: true, DeadlineAt: now.Add(48 * time.Hour), OriginalMinor: 1000, AvailableMinor: 1000}, instruction: paymentport.ProfitSharingInstruction{Reference: "psinst_1", SettlementRef: "dstl_commission_41", OriginalPaymentRef: "payref_17", AmountMinor: 100, Currency: "CNY", EffectRef: "eer_1", DeadlineAt: now.Add(48 * time.Hour), UpdatedAt: now}, unfreeze: paymentport.ProfitSharingUnfreeze{Reference: "psunfreeze_1", State: "succeeded", OutcomeKnown: true, UpdatedAt: now}}
