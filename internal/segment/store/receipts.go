...
func validKind(kind string) bool {
	return kind == "group" || kind == "package" || kind == "configuration" || kind == "refresh_run" || kind == "snapshot" || kind == "webhook_receipt" || kind == "binding" || kind == "sender_set" || kind == "schedule" || kind == "member_event_batch"
}
