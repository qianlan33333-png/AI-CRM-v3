...
func TestMediaUIRendersEveryFrozenWorkspaceWithStablePageKey(t *testing.T) {
	...
	handler := NewModuleRegistration().UIBinding(dist, func(w http.ResponseWriter, _ *http.Request, page, donor string, assets MediaAssets) error {
		got = append(got, page)
		if donor == "" || assets.AdminJS != "/media-assets/assets/admin.js" || assets.MaterialSaveHostJS != "/media-assets/assets/material-save.js" || assets.ImageLibraryFilterHostJS != "/media-assets/assets/image-filter.js" {
