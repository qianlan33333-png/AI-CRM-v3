...
AND NOT EXISTS (SELECT 1 FROM unnest(ARRAY[
 ...
 'hxc_dashboard_rows.learning_plan_status','hxc_dashboard_rows.learning_plan_current','hxc_dashboard_rows.learning_plan_total',
 'hxc_dashboard_rows.card_open_count_7d','hxc_dashboard_rows.card_last_opened_at',
 'hxc_dashboard_rows.membership_record_found','hxc_dashboard_rows.is_member','hxc_dashboard_rows.membership_status'
