...
CASE WHEN mc.user_id IS NOT NULL OR (mc.user_id IS NULL AND COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> '' AND COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> 'free') THEN 1 ELSE 0 END,
CASE WHEN mc.user_id IS NOT NULL THEN CASE WHEN mc.status COLLATE utf8mb4_general_ci IN ('active','valid','premium','standard','trial') THEN 1 ELSE 0 END WHEN COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> '' AND COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> 'free' THEN 1 ELSE 0 END,
CASE WHEN mc.user_id IS NOT NULL THEN COALESCE(mc.attribution,'none') WHEN COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> '' AND COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> 'free' THEN 'subscription' ELSE 'none' END,
CASE WHEN mc.user_id IS NOT NULL THEN COALESCE(mc.status,'') WHEN COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> '' AND COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> 'free' THEN COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') ELSE '' END,
CASE WHEN mc.user_id IS NOT NULL THEN mc.end_date WHEN COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> '' AND COALESCE(NULLIF(TRIM(s.tier),''),NULLIF(TRIM(u.member_level),''),'') COLLATE utf8mb4_general_ci <> 'free' THEN COALESCE(s.expires_at,u.member_expires_at) ELSE NULL END,
