...
func readBatch(ctx context.Context, tx *sql.Tx, after string, asOf time.Time) ([]domain.SourceRow, error) {
	...
	for rows.Next() {
		...
		var expiry, lastUsed sql.NullTime
...
NULLIF(GREATEST(COALESCE(c.peer_last,'1000-01-01'),COALESCE(coach.last_used,'1000-01-01'),COALESCE(c.lesson_last,'1000-01-01'),COALESCE(a.last_used,'1000-01-01'),COALESCE(r.last_used,'1000-01-01'),COALESCE(msg.last_used,'1000-01-01')),'1000-01-01'),
