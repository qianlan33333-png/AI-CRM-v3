	...
	tests := []struct {
		...
		},
		{
			...
			contains: []string{
				...
				"data-jssdk-config-url=\"/api/v3/sidebar/jssdk-config\"",
				"data-context-token-url=\"/api/v3/sidebar/context-token\"",
				"data-workbench-url=\"/api/v3/sidebar/workbench\"",
			},
			notContain: []string{"/api/sidebar/v2/", "fetch(", "XMLHttpRequest", "sendBeacon"},
		},
		{
			name:   "css asset",
			method: http.MethodGet,
