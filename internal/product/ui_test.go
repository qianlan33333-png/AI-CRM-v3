...
func TestProductUIAllowlistUsesDonorTemplateAndMountsDataPage(t *testing.T) {
	...
	manifest := buildManifest{Entries: map[string]string{"tokens": "assets/tokens.css", "labs": "assets/labs.css", "productHost": "assets/product-host.js", "standardComponentsHost": "assets/standard-components-host.js"}, Files: map[string]json.RawMessage{"assets/tokens.css": json.RawMessage("null"), "assets/labs.css": json.RawMessage("null"), "assets/product-host.js": json.RawMessage("null"), "assets/standard-components-host.js": json.RawMessage("null"), "assets/standard-components/material_picker.css": json.RawMessage("null"), "assets/standard-components/send_content_composer.css": json.RawMessage("null"), "assets/standard-components/wecom_tag_picker.css": json.RawMessage("null")}}
	...
	for name, content := range map[string]string{"tokens.css": "tokens", "labs.css": "labs", "product-host.js": "host", "standard-components-host.js": "standard host", "standard-components/material_picker.css": "material", "standard-components/send_content_composer.css": "composer", "standard-components/wecom_tag_picker.css": "tag"} {
	...
	if recorder.Code != http.StatusOK || rendered.page != "products" || !strings.Contains(rendered.body, "donor body") || rendered.assets.HostJS != "/product-assets/product-host.js" || rendered.assets.StandardHostJS != "/product-assets/standard-components-host.js" || len(rendered.assets.StandardCSS) != 3 {
