...
func TestH5OAuthStateIsBoundExpiresAndCannotReplay(t *testing.T) {
	...
	for _, path := range []string{"/distribution", "/distribution?product_id=7&product_type=standard_product", "/distribution?product_id=8&product_type=service_period", "/p/subscription_trial_month", "/p/course-7", "/p/7", "/s/term-31", "/s/term-31/pay", "/c/coupon-2026", "/p/course-7?promotion_context=" + promotion, "/pay/course-7?promotion_context=" + promotion, "/s/term-31?promotion_context=" + promotion, "/s/term-31/pay?promotion_context=" + promotion} {
