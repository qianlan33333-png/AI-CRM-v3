...
func TestH5OAuthStateIsBoundExpiresAndCannotReplay(t *testing.T) {
	...
	for _, path := range []string{"/p/subscription_trial_month", "/p/course-7", "/p/7", "/s/term-31", "/s/term-31/pay", "/c/coupon-2026"} {
