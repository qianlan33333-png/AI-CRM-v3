...
}, security surveyhttp.RequestSecurity) (HTTPBindings, error) {
	if m == nil {
		return HTTPBindings{}, errors.New("survey module required")
	}
	handler, err := surveyhttp.NewHandler(definitions, submissions, security)
	if err != nil {
