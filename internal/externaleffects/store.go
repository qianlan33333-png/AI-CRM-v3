...
func projectsStaleAttempt(kind Kind) bool {
	switch kind {
	case KindOutboundMedia, KindWeComTagCatalog, KindWeComTagCatalogMutation, KindGroupMessage, KindChannelAsset, KindOutboundMessage, KindAutomationMessage, KindSurveyCompletion, KindCustomerTagCommand, KindCustomerOwnerHandoff, KindCommerceProductPush, KindAIAgentGenerate, port.KindSidebarJSSDKSend:
		return true
	default:
		return false
	}
