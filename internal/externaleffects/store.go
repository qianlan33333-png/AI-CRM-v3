...
func projectsStaleAttempt(kind Kind) bool {
	switch kind {
	case KindWeComTagCatalog, KindGroupMessage, KindChannelAsset, KindOutboundMessage, KindAutomationMessage, KindSurveyCompletion, KindCommerceProductPush:
		return true
	default:
		return false
	}
