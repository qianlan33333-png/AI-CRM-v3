...
test -n "$rollback_line" && test -n "$exit_line" && test -n "$restart_line" && test -n "$active_line" && test -n "$active_exit_line" || {
...
test "$start_line" -lt "$active_line" && test "$active_line" -lt "$active_exit_line" || {
