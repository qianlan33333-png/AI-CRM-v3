...
func (*openPlatformOrderStub) Get(context.Context, int64) (orderdomain.Snapshot, error) {
	return orderdomain.Snapshot{}, orderport.ErrNotFound
}
func (*openPlatformOrderStub) GetByReference(context.Context, string) (orderdomain.Snapshot, error) {
	return orderdomain.Snapshot{}, orderport.ErrNotFound
}
...
type openPlatformProfileStub struct{}

func (openPlatformProfileStub) ReadSidebarProfile(_ context.Context, id customerdomain.CustomerID) (customerport.SidebarProfile, error) {
...
func TestOpenPlatformIdentityUsesDeclaredScopedReferenceAndDoesNotProvision(t *testing.T) {
	...
	executor, err := newOpenPlatformExecutor(identity, &openPlatformOrderStub{}, openPlatformProfileStub{}, openPlatformArchiveStub{}, "corp-main")
	if err != nil {
		t.Fatal(err)
	}
...
func TestOpenPlatformMCPReturnsArchiveNotReadyAsAnExplicitFact(t *testing.T) {
	...
	executor, err := newOpenPlatformExecutor(identity, &openPlatformOrderStub{}, openPlatformProfileStub{}, openPlatformArchiveStub{err: archiveport.ErrNotReady}, "corp-main")
	if err != nil {
		t.Fatal(err)
	}
...
func TestOpenPlatformOrdersMapScopedIdentityBeforeCallingOrderPort(t *testing.T) {
	...
	executor, err := newOpenPlatformExecutor(identity, orders, openPlatformProfileStub{}, openPlatformArchiveStub{}, "corp-main")
	if err != nil {
		t.Fatal(err)
	}
