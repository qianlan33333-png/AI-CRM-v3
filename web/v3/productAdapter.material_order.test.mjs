...
const dom = new JSDOM(page, {
  ...
  beforeParse(window) {
    ...
    window.fetch = async (input, init = {}) => {
      ...
      if (url.pathname === '/api/admin/wechat-pay/products/101/external-push') return json({ product_id: 101, product_kind: 'wechat_pay', enabled: false, configuration_reference: '', revision: 0, webhook_url: '', push_type: '', expires_at_ts: null, day: null, frequency: null, remark: '', custom_params: {}, updated_at: '' });
