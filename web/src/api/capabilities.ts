...
export const CAPABILITIES: readonly Capability[] = [
  ...
  { surface: 'admin', screen: 'automation/audienceEdit', action: '预览并二次确认持久群发运行', state: 'real', operation: 'createAutomationBroadcastPreview/confirmAutomationRun/listAutomationRuns/listAutomationRunRecipients' },
