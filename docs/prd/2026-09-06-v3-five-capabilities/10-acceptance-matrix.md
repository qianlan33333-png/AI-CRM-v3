...
|---|---|---|---|---|
| 负责人迁移 | 01 已批准 | 两模式、真实 River/Provider fixture、并发互斥已有测试 | #171 `deef2f2f98974242302f7b9d2b4e49b8633a11ee` | 未通过整板块：20,000 条分段恢复、历史、完整浏览器旅程待补 |
...
| 配置中心运行生效 | 05 已批准 | 根独立 PG/race/HTTP/Host/history及installer测试通过 | #170 `db70fcb6518cbf813a37ef201506fa6bfbb10b60` | 业务及最后导入边界门禁修正独立复核通过；对齐最新main后等待完整CI |
