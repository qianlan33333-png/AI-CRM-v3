...
| 板块 | 唯一业务 PR | 当前状态（2026-09-06 20:24 UTC） |
|---|---|---|
| 负责人迁移 | #171 已合并 | 已部署5291366；历史32,411条已对账，4,084待映射；真实转接另验 |
| 通用客户标签 | #169 已合并 | 已部署并启用通用写入Provider；历史305条已对账，115待映射 |
| 配置中心运行生效 | #170 已合并 | 已部署；有效值仍环境默认revision0，旧8条历史无等价关系，未发布新业务值 |
| 商品／订单外推 | #172 已合并 | 已部署；800历史已对账；24配置保存、9启用，真实新订单外推另验 |
| 通用开放平台 | #173 已合并 | 已部署5291366，运行参数生效，真实HTTPS OAuth/REST/MCP验收通过；历史12待重签/5排除、14审计已核验 |
| 新前端壳 | #164 已合并 | 5291366已部署；PR及main完整检查通过，生产30页面/284资源通过，新壳及业务Host生效 |
